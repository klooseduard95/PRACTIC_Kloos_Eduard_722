...
public class ArenaRepository {
    ...
    public void writeReportToFile(Map<String, Long> reportData, String filename) {
        try (PrintWriter writer = new PrintWriter(Files.newBufferedWriter(Paths.get(filename)))) {
            reportData.forEach((key, value) -> writer.println(key + " -> " + value));
            System.out.println("Successfully wrote arena report to " + filename);
        } catch (IOException e) {
